...
class ConversationListCreateView(generics.CreateAPIView):
    ...
    def create(self, request, *args, **kwargs):
        ...
        if existing_conversation.exisits():
            return Response(
...
class MessageListCreatView(generics.CreateAPIView):
    permission_classes = [IsAuthenticated]
    ...
    def get_conversation(self,conversation_id):
        conversation = get_object_or_404(Conversation,conversation_id)
